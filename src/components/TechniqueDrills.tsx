...
export default function TechniqueDrills() {
  ...
  return (
    <div id="rechnique-hub-container" className="bg-dark-card border border-dark-border rounded-xl overflow-hidden">
      
      {/* Panel Header */}
      <div className="border-b border-dark-border bg-neutral-950 p-4 flex items-center gap-2.5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3">
        ...
        <div className="border-r border-dark-border p-3 space-y-2 bg-neutral-950/20">
        ...
        {/* Right column details of chosen drill */}
        <div className="md:col-span-2 p-5 bg-neutral-950/40 flex flex-col justify-between">
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div className="bg-neutral-950/60 border border-dark-border/60 rounded-lg p-3.5">
          ...
          {/* Tips notification */}
          <div className="mt-6 p-3 bg-neutral-900/60 border border-dark-border/40 rounded-lg text-xs flex gap-2.5 items-start">
